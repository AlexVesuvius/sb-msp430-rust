...
impl Timer {
    pub fn new(inner: msp430fr2433::TIMER0_A3) -> Self {
...
pub struct Serial {
    inner: msp430fr2433::USCI_A0_UART_MODE,
}

impl Serial {
    pub fn new(inner: msp430fr2433::USCI_A0_UART_MODE) -> Self {
...
pub struct I2c {
    inner: msp430fr2433::USCI_B0_I2C_MODE,
    ifg: Ucb0Ifg,
}

impl I2c {
    pub fn new(inner: msp430fr2433::USCI_B0_I2C_MODE, ifg: Ucb0Ifg) -> Self {
...
pub struct WatchdogTimer {
    inner: msp430fr2433::WATCHDOG_TIMER,
}

impl WatchdogTimer {
    pub fn new(inner: msp430fr2433::WATCHDOG_TIMER) -> Self {
        WatchdogTimer { inner }
    }
...
impl SfrIfg {
    pub fn new(_token: msp430fr2433::SPECIAL_FUNCTION) -> Self {
        ...
        let ucb0txifg =
            unsafe { Ucb0TxIfg::new(msp430fr2433::Peripherals::steal().SPECIAL_FUNCTION) };
        let ucb0rxifg =
            unsafe { Ucb0RxIfg::new(msp430fr2433::Peripherals::steal().SPECIAL_FUNCTION) };
...
pub struct Ucb0TxIfg {
    inner: msp430fr2433::SPECIAL_FUNCTION,
}

impl Ucb0TxIfg {
    fn new(inner: msp430fr2433::SPECIAL_FUNCTION) -> Self {
        Ucb0TxIfg { inner }
    }
