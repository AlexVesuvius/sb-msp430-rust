...
//! variable.
//!
//! The [Periperhals](msp430fr2433::Peripherals) type, and individual peripherals never need
//! to be modified. Therefore, [Periperhals](msp430fr2433::Peripherals) (or a subset of the
...
use msp430_rt::entry;
use msp430fr2433::{interrupt, Peripherals};
